...
import {
  ...
  render
} from "./chunk-RYSAFDGI.js";
import {
  Source_default,
  Vector_default,
  loadFeaturesXhr
} from "./chunk-47PV26IU.js";
import "./chunk-C5KGH6RQ.js";
import {
  Feature_default
} from "./chunk-KZSSB2DG.js";
import {
  TileQueue_default
} from "./chunk-6RO5JMRV.js";
import {
  TileState_default
} from "./chunk-5D2XPBR2.js";
import "./chunk-D72A4W6J.js";
import {
  Layer_default as Layer_default2
} from "./chunk-NEH3RP36.js";
import "./chunk-JT33CQTS.js";
import {
  ImageBase_default,
  ImageState_default,
  Image_default
} from "./chunk-7HIIEAE7.js";
import {
  Layer_default
} from "./chunk-TIACNJM3.js";
import {
  buffer as buffer2,
  ...
  scale as scale2,
  toSize
} from "./chunk-I6HGGNAY.js";
import {
  DEFAULT_MAX_ZOOM,
  DEFAULT_TILE_SIZE,
  ViewHint_default
} from "./chunk-ERTMH2RJ.js";
import {
  Point_default,
  apply,
  compose,
...
addDecoder(
  34887,
  () => import("./lerc-ZZYMVPE2.js").then(async (m) => {
    await m.zstd.init();
    return m;
  }).then((m) => m.default)
);
  ...
  constructor(size = defaultPoolSize, createWorker2) {
    ...
    if (size) {
      this._awaitingDecoder = createWorker2 ? Promise.resolve(createWorker2) : new Promise((resolve) => {
        import("./decoder-OQXSAKBN.js").then((module) => {
...
var ImageWMS = class extends Image_default3 {
  ...
  getImageInternal(extent, resolution, pixelRatio, projection) {
    ...
    const marginWidth = ceil((this.ratio_ - 1) * viewWidth / 2, DECIMALS2);
    const requestWidth = viewWidth + 2 * marginWidth;
    const marginHeight = ceil((this.ratio_ - 1) * viewHeight / 2, DECIMALS2);
...
function parseTileMatrixSet(sourceInfo, tileMatrixSet, tileUrlTemplate, tileMatrixSetLimits) {
  ...
  const context2 = sourceInfo.context;
  ...
  function tileUrlFunction(tileCoord, pixelRatio, projection2) {
    ...
    Object.assign(localContext, context2);
